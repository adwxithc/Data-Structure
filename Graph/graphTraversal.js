...
class Graph {
    ...
    bfs(startingVertex) {
        ...
        while (queue.length > 0) {
            ...
            for (const adjacentVertex of this.adjacency[currentVertex]) {
        ...
        // Check if there are any remaining unvisited vertices
...
console.log('BFS traversal for the unconnected graph:');
g.bfs('A');
